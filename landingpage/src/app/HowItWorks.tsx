      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-stone-500">
            Nggak perlu coding, nggak perlu keahlian teknis. WANI dirancang
            untuk pemilik UMKM yang sibuk.
          </p>
        </div>

        <div
          ref={stepsRef}
          className="relative mx-auto max-w-2xl flex flex-col gap-0"
        >
          {STEPS.map((step, i) => (
            <div
              key={step.num}
              className="step-item relative flex gap-6"
              style={{ opacity: 0 }}
            >
              <div className="flex flex-col items-center">
                ...
                {i < STEPS.length - 1 && (
                  <div
                    className="mt-2 w-px flex-1 bg-gradient-to-b from-teal-300 to-teal-100"
                    style={{ minHeight: 60 }}
                  />
                )}
              </div>
