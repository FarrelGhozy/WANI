      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        <div ref={innerRef} style={{ opacity: 0 }}>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              to="/app/signup"
              className="group inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-base font-semibold text-teal-800 shadow-lg transition-all hover:bg-teal-50 hover:shadow-xl"
            >
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 rounded-full border border-teal-400/50 px-8 py-4 text-base font-semibold text-white transition-all hover:border-teal-300 hover:bg-teal-800/40"
            >
