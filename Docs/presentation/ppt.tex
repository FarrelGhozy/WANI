...
\author{\href{https://github.com/FarrelGhozy}{Farrel Ghozy} \and \href{https://github.com/jaweed3}{Fatih Jawwad} \and \href{https://github.com/MowlandCodes}{M. Faridh Maulana} \and Naufal Razzaq}
\date{}
...
\begin{frame}[plain,noframenumbering]
  ...
  {\fontsize{13}{16}\selectfont
    ...
    \href{https://github.com/MowlandCodes}{M. Faridh Maulana} $\cdot$
    Naufal Razzaq
  }
  \\[6pt]
...
\begin{frame}{Tim}
  \begin{columns}[T]
    \column{0.5\textwidth}
    \centering
    {\large\textbf{Farrel Ghozy}} \\[-2pt]
    \small Backend, AI Pipeline, Bot, Infra \\[-2pt]
    \footnotesize\href{https://github.com/FarrelGhozy}{@FarrelGhozy}

    \vspace{12pt}

    {\large\textbf{M. Faridh Maulana}} \\[-2pt]
    \small Backend \\[-2pt]
    \footnotesize\href{https://github.com/MowlandCodes}{@MowlandCodes}

    \column{0.5\textwidth}
    \centering
    {\large\textbf{Fatih Jawwad}} \\[-2pt]
    \small AI Pipeline \\[-2pt]
    \footnotesize\href{https://github.com/jaweed3}{@jaweed3}

    \vspace{12pt}

    {\large\textbf{Naufal Razzaq}} \\[-2pt]
    \small Proposal \& Video \\[-2pt]
    \footnotesize @naufalrzq
  \end{columns}
\end{frame}
