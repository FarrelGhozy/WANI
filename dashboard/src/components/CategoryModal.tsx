    ...
    <>
      <Modal open={open} onClose={onClose} title="Kelola Kategori">
        ...
        <div className="mb-5 rounded-lg border border-teal-200 bg-teal-50 p-4">
          <h3 className="mb-3 text-sm font-medium text-teal-800">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              {newName || newDesc ? (
                <Button size="sm" variant="secondary" onClick={resetNew}>
                  Batal
                </Button>
              ) : null}
            </div>
      ...
      >
        <p className="text-sm text-stone-600">
          ...
          Produk dalam kategori ini akan menjadi{" "}
          <strong className="text-stone-900">Tanpa Kategori</strong>.
        </p>
      </Modal>
    </>
  );
