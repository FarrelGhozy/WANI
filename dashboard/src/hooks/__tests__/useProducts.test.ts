...
function setupProductFetch(
  products: Product[] = [mockProduct, mockProduct2],
  categories: Category[] = [mockCategory, mockCategory2]
) {
...
describe("useProducts", () => {
  ...
  describe("category CRUD", () => {
    ...
    it("updates category", async () => {
      ...
      expect(result.current.categories.find((c) => c.id === "c1")!.name).toBe(
        "Makanan Berat"
      );
    });
