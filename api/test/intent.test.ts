...
const testCases: TestCase[] = [
  ...
  {
    text: "Saya mau order ayam geprek 1 dan es teh 2",
  ...
  {
    text: "Apa saja menu yang tersedia?",
    expectedIntent: "inquiry",
    lang: "id",
  },
  {
    text: "Jam buka sampai jam berapa?",
    expectedIntent: "inquiry",
    lang: "id",
  },
  ...
  // Complaints
  {
    text: "Pesanan saya salah, saya pesan nasi goreng tapi dikasih mie",
    expectedIntent: "complaint",
    lang: "id",
  },
  {
    text: "Makanannya dingin dan tidak enak",
    expectedIntent: "complaint",
    lang: "id",
  },
  {
    text: "The food is cold and late",
    expectedIntent: "complaint",
    lang: "en",
  },
  {
    text: "Saya mau refund pesanan saya",
    expectedIntent: "complaint",
    lang: "id",
  },
  ...
  {
    text: "Customer service nya dimana? Saya mau komplain langsung",
    expectedIntent: "escalate",
    lang: "id",
  },
